...
The project is a reproducible research foundation, not a claim to contain “every battle ever.” The current expanded provisional release contains 2,373 catalogued, time-bounded polity identities, of which 1,017 actually participate in rated evidence across 5,416 events. It currently includes:
...
The dashboard deliberately separates the polity registry from the rating ledger. The 2,373-entry registry includes unrated and explicitly superseded source candidates; absence from the ledger is not a defeat. The release entity file has 1,025 records, of which 1,017 distinct entity IDs actually participate in rated events. The 5,416-event ledger combines 40 manually curated seed events, 1,887 crosswalk-resolved, 2,481 label-resolved, and 784 candidate-keyed HCED tactical encounters: 76 from Wave 6, 192 from Wave 7, and 516 from Wave 8. It also contains 64 coalition-aggregated IWD strategic parent wars, 153 IWBD tactical battles, and 7 UCDP conflict-termination strategic episodes. Source-derived entries remain visibly provisional and must not be published as a comprehensive historical conclusion.

The 5,152 already-rated HCED events also carry an audited, rating-neutral
location tranche where the source assertion survives fail-closed quarantine:
4,795 exact GeoJSON Points, 5,057 source-transcribed geographic-jurisdiction
labels in `modern_location_country`, and 5,106 closed `location_provenance`
...
The 1,464-source registry spans 1,199 provenance families and also makes the
outcome-provenance contract explicit. Of the 5,416 rated events, 5,376 map
through explicit event outcome metadata to at least one direct outcome family:
5,152 HCED-derived events, 64 IWD parent wars, 153 IWBD battles, and 7 UCDP
conflict-termination episodes. Of those mapped events, 5,017 cite one direct
outcome family and 359 cite more than one. The 40 curated seed events remain
...
- Cliopatria v0.2.0: 1,637 time-bounded identity candidates spanning 3400 BCE–2024, consolidated with curated and explicitly superseded identities into the 2,373-entry registry;
...
event-like candidates, 36,932 remain outside the rating ledger. The additive
