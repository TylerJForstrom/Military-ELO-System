...
The project is a reproducible research foundation, not a claim to contain “every battle ever.” The current expanded provisional release contains 1,590 catalogued, time-bounded polity identities, of which 226 have rateable evidence across 4,341 events. It currently includes:
...
The dashboard deliberately separates the polity registry from the rating ledger. The 1,590-entry registry includes unrated source candidates; absence from the ledger is not a defeat. The 4,341-event ledger combines 40 manually curated seed events, 1,798 crosswalk-resolved and 2,274 label-resolved HCED tactical encounters, 55 coalition-aggregated IWD strategic parent wars, 167 IWBD tactical battles, and 7 UCDP conflict-termination strategic episodes. Source-derived entries remain visibly provisional and must not be published as a comprehensive historical conclusion.
