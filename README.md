...
The project is a reproducible research foundation, not a claim to contain “every battle ever.” The current expanded provisional release contains 2,372 catalogued, time-bounded polity identities, of which 1,016 actually participate in rated evidence across 5,414 events. It currently includes:
...
The dashboard deliberately separates the polity registry from the rating ledger. The 2,372-entry registry includes unrated and explicitly superseded source candidates; absence from the ledger is not a defeat. The release entity file has 1,024 records, of which 1,016 distinct entity IDs actually participate in rated events. The 5,414-event ledger combines 40 manually curated seed events, 1,887 crosswalk-resolved, 2,481 label-resolved, and 782 candidate-keyed HCED tactical encounters: 76 from Wave 6, 192 from Wave 7, and 514 from Wave 8. It also contains 64 coalition-aggregated IWD strategic parent wars, 153 IWBD tactical battles, and 7 UCDP conflict-termination strategic episodes. Source-derived entries remain visibly provisional and must not be published as a comprehensive historical conclusion.

The 5,150 already-rated HCED events also carry an audited, rating-neutral
location tranche where the source assertion survives fail-closed quarantine:
4,794 exact GeoJSON Points, 5,055 source-transcribed geographic-jurisdiction
labels in `modern_location_country`, and 5,104 closed `location_provenance`
...
The 1,457-source registry spans 1,193 provenance families and also makes the
outcome-provenance contract explicit. Of the 5,414 rated events, 5,374 map
through explicit event outcome metadata to at least one direct outcome family:
5,150 HCED-derived events, 64 IWD parent wars, 153 IWBD battles, and 7 UCDP
conflict-termination episodes. Of those mapped events, 5,017 cite one direct
outcome family and 357 cite more than one. The 40 curated seed events remain
...
event-like candidates, 36,934 remain outside the rating ledger. The additive
