...
WAVE8_NEW_ZEALAND_ENTITIES: tuple[dict[str, Any], ...] = (
    ...
    _entity("pai_marire_forces_1864", "Pai Mārire forces (1864–1866)", "religious_movement_force", 1864, 1866, ["nzhistory_taranaki_second_war", "nzhistory_moutoa_1864"], "Conflict-bounded Pai Mārire combatants through the 1866 Otapawa fighting; later Tītokowaru and Te Kooti forces remain separate."),
