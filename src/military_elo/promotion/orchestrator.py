...
def build_expanded_release(
    ...
    wave8_followup_c_queue_validation = validate_wave8_followup_c_queue_contracts(
        hced
    )
    wave8_followup_d_queue_validation = validate_wave8_followup_d_queue_contracts(
        hced
    )
    ...
    wave8_followup_c_discovery_validation = (
        validate_wave8_followup_c_discovery_dispositions(
            wikidata_battle_candidates
        )
    )
    wave8_followup_d_discovery_validation = (
        validate_wave8_followup_d_discovery_dispositions(
            wikidata_battle_candidates
        )
    )
    ...
    install_wave8_followup_c_entities(release_entities)
    wave8_followup_c_existing_entity_validation = (
        validate_wave8_followup_c_existing_entities(release_entities)
    )
    ...
    wave8_followup_c_existing_events = [
        *wave8_followup_b_existing_events,
        *wave8_followup_b_events,
    ]
    wave8_followup_c_events = promote_wave8_followup_c_contracts(
        hced,
        release_entities,
        wave8_followup_c_existing_events,
    )
    wave8_followup_d_existing_events = [
        *wave8_followup_c_existing_events,
        *wave8_followup_c_events,
    ]
    wave8_followup_d_events = promote_wave8_followup_d_contracts(
        hced,
        release_entities,
        wave8_followup_d_existing_events,
    )
    ...
    wave8_followup_e_events = promote_wave8_followup_e_contracts(
        hced,
        release_entities,
        wave8_followup_e_existing_events,
    )
    ...
    wave8_followup_b_integration_validation = (
        validate_wave8_followup_b_integration_dispositions(
            hced,
            iwbd_candidates,
            all_events,
    ...
    wave8_followup_b_final_validation = validate_wave8_followup_b_final_audit(
        release_entities,
        sources_by_id,
        all_events,
        wave8_followup_b_metadata(),
    )
    wave8_followup_c_integration_validation = (
        validate_wave8_followup_c_integration_dispositions(
            hced,
            iwd_candidates,
            iwbd_candidates,
    ...
    wave8_followup_c_artifact_validation = (
        validate_wave8_followup_c_current_artifact_state(
            all_events,
            release_entities.values(),
            sources_by_id.values(),
    ...
    wave8_followup_d_artifact_validation = (
        validate_wave8_followup_d_artifact_state(
            all_events,
            release_entities.values(),
            sources_by_id.values(),
    ...
    wave8_followup_e_brecke_rows = read_jsonl(
        review.parent / "reference" / "brecke-wars.jsonl"
    )
    wave8_followup_e_ucdp_rows = [
        *wave8_taliban_al_qaeda_ucdp_rows,
        *read_jsonl(review / "ucdp-actor-26.1-candidates.jsonl"),
    ]
    wave8_followup_e_discovery_validation = (
        validate_wave8_followup_e_discovery_dispositions(
            hced,
            iwbd_candidates,
    ...
    wave8_followup_e_integration_validation = (
        validate_wave8_followup_e_integration_dispositions(
            hced,
            iwd_candidates,
            iwbd_candidates,
    ...
    wave8_followup_e_artifact_validation = (
        validate_wave8_followup_e_artifact_state(
            all_events,
            release_entities.values(),
            sources_by_id.values(),
    ...
    wave8_exact_priority_final_validation = (
        validate_wave8_exact_priority_final_audit(
            release_entities,
            sources_by_id,
            all_events,
    ...
    coverage = {
        ...
        "candidate_keyed_wave8_followup_c_hced_events": len(
            wave8_followup_c_events
        ),
        "candidate_keyed_wave8_followup_d_hced_events": len(
            wave8_followup_d_events
        ),
    ...
    metadata = {
        **seed_metadata,
        ...
        "promotion": {
            ...
            "accepted_wave8_followup_c_hced_events": len(
                wave8_followup_c_events
            ),
            "accepted_wave8_followup_d_hced_events": len(
                wave8_followup_d_events
            ),
            ...
            "wave8_followup_b_audit_signature": wave8_followup_b_audit_signature(),
            "wave8_followup_b_final_audit_signature": (
                WAVE8_FOLLOWUP_B_FINAL_AUDIT_SIGNATURE
            ),
            "wave8_followup_b_queue_validation": (
                wave8_followup_b_queue_validation
            ),
            "wave8_followup_b_integration_validation": (
                wave8_followup_b_integration_validation
            ),
            "wave8_followup_b_final_validation": (
                wave8_followup_b_final_validation
            ),
            "wave8_followup_b_candidate_ids": sorted(
                WAVE8_FOLLOWUP_B_CONTRACT_IDS
            ),
            "wave8_followup_b_holds": [
                {"candidate_id": candidate_id, **contract}
                for candidate_id, contract in sorted(
                    WAVE8_FOLLOWUP_B_HOLDS.items()
                )
            ],
            "wave8_followup_b_exact_label_funnel_audit": (
                WAVE8_FOLLOWUP_B_FUNNEL_AUDIT
            ),
            "wave8_followup_b_location_quarantine_reasons": [
                {"candidate_id": candidate_id, **contract}
                for candidate_id, contract in sorted(
                    WAVE8_FOLLOWUP_B_LOCATION_QUARANTINE_REASONS.items()
                )
            ],
            "wave8_followup_b_point_quarantine_additions": sorted(
                WAVE8_FOLLOWUP_B_POINT_QUARANTINE_ADDITIONS
            ),
            "wave8_followup_b_country_quarantine_additions": sorted(
                WAVE8_FOLLOWUP_B_COUNTRY_QUARANTINE_ADDITIONS
            ),
            "wave8_followup_b_entities_added": len(WAVE8_FOLLOWUP_B_ENTITIES),
            "wave8_followup_b_sources_added": len(WAVE8_FOLLOWUP_B_SOURCES),
            "wave8_followup_c_metadata": wave8_followup_c_metadata(),
            "wave8_followup_c_counts": wave8_followup_c_counts(),
            "wave8_followup_c_audit_signature": wave8_followup_c_audit_signature(),
            "wave8_followup_c_final_audit_signature": (
                WAVE8_FOLLOWUP_C_FINAL_AUDIT_SIGNATURE
            ),
            "wave8_followup_c_queue_validation": (
                wave8_followup_c_queue_validation
            ),
            "wave8_followup_c_discovery_validation": (
                wave8_followup_c_discovery_validation
            ...
            "wave8_followup_c_candidate_ids": sorted(
                WAVE8_FOLLOWUP_C_CONTRACT_IDS
            ),
            "wave8_followup_c_holds": [
                {"candidate_id": candidate_id, **contract}
                for candidate_id, contract in sorted(
                    WAVE8_FOLLOWUP_C_HOLDS.items()
                )
            ],
            "wave8_followup_c_terminal_exclusions": [
                {"candidate_id": candidate_id, **contract}
                for candidate_id, contract in sorted(
                    WAVE8_FOLLOWUP_C_TERMINAL_EXCLUSIONS.items()
                )
            ],
            "wave8_followup_c_location_quarantine_reasons": [
                {"candidate_id": candidate_id, **contract}
                for candidate_id, contract in sorted(
                    WAVE8_FOLLOWUP_C_LOCATION_QUARANTINE_REASONS.items()
                )
            ],
            "wave8_followup_c_point_quarantine_additions": sorted(
                WAVE8_FOLLOWUP_C_POINT_QUARANTINE_ADDITIONS
            ),
            "wave8_followup_c_country_quarantine_additions": sorted(
                WAVE8_FOLLOWUP_C_COUNTRY_QUARANTINE_ADDITIONS
            ),
            "wave8_followup_c_entities_added": len(WAVE8_FOLLOWUP_C_ENTITIES),
            "wave8_followup_c_sources_added": len(WAVE8_FOLLOWUP_C_SOURCES),
            "wave8_bilbao_exact_label_funnel_audit": (
                WAVE8_FOLLOWUP_C_BILBAO_FUNNEL_AUDIT
            ),
            "wave8_followup_d_metadata": wave8_followup_d_metadata(),
            "wave8_followup_d_counts": wave8_followup_d_counts(),
            "wave8_followup_d_audit_signature": wave8_followup_d_audit_signature(),
            "wave8_followup_d_final_audit_signature": (
                WAVE8_FOLLOWUP_D_FINAL_AUDIT_SIGNATURE
            ),
            "wave8_followup_d_queue_validation": (
                wave8_followup_d_queue_validation
            ),
            "wave8_followup_d_discovery_validation": (
                wave8_followup_d_discovery_validation
            ...
            "wave8_followup_d_candidate_ids": sorted(
                WAVE8_FOLLOWUP_D_CONTRACT_IDS
            ),
            "wave8_followup_d_holds": [
                {"candidate_id": candidate_id, **contract}
                for candidate_id, contract in sorted(
                    WAVE8_FOLLOWUP_D_HOLDS.items()
                )
            ],
            "wave8_followup_d_location_quarantine_reasons": [
                {"candidate_id": candidate_id, **contract}
                for candidate_id, contract in sorted(
                    WAVE8_FOLLOWUP_D_LOCATION_QUARANTINE_REASONS.items()
                )
            ],
            "wave8_followup_d_point_quarantine_additions": sorted(
                WAVE8_FOLLOWUP_D_POINT_QUARANTINE_ADDITIONS
            ),
            "wave8_followup_d_country_quarantine_additions": sorted(
                WAVE8_FOLLOWUP_D_COUNTRY_QUARANTINE_ADDITIONS
            ),
            "wave8_followup_d_entities_added": len(WAVE8_FOLLOWUP_D_ENTITIES),
            "wave8_followup_d_sources_added": len(WAVE8_FOLLOWUP_D_SOURCES),
            "wave8_swabian_hre_exact_label_funnel_audit": (
                WAVE8_FOLLOWUP_D_FUNNEL_AUDITS["swabian_hre"]
            ),
            "wave8_cuban_exact_label_funnel_audit": (
                WAVE8_FOLLOWUP_D_FUNNEL_AUDITS["cuban"]
            ),
            "wave8_lower_canada_exact_label_funnel_audit": (
                WAVE8_FOLLOWUP_D_FUNNEL_AUDITS["lower_canada"]
            ),
            "wave8_irish_royalists_exact_label_funnel_audit": (
                WAVE8_FOLLOWUP_D_FUNNEL_AUDITS["irish_royalists"]
            ),
            "wave8_finnish_civil_war_exact_label_funnel_audit": (
                WAVE8_FOLLOWUP_D_FUNNEL_AUDITS["finnish_civil_war"]
            ),
            "wave8_followup_e_metadata": wave8_followup_e_metadata(),
            "wave8_followup_e_counts": wave8_followup_e_counts(),
            "wave8_followup_e_audit_signature": wave8_followup_e_audit_signature(),
            "wave8_followup_e_final_audit_signature": (
                WAVE8_FOLLOWUP_E_FINAL_AUDIT_SIGNATURE
            ),
            "wave8_followup_e_queue_validation": (
                wave8_followup_e_queue_validation
            ),
            "wave8_followup_e_discovery_validation": (
                wave8_followup_e_discovery_validation
            ...
            "wave8_followup_e_candidate_ids": sorted(
                WAVE8_FOLLOWUP_E_CONTRACT_IDS
            ),
            "wave8_followup_e_holds": [
                {"candidate_id": candidate_id, **contract}
                for candidate_id, contract in sorted(
                    WAVE8_FOLLOWUP_E_HOLDS.items()
                )
            ],
            "wave8_followup_e_terminal_exclusions": [
                {"candidate_id": candidate_id, **contract}
                for candidate_id, contract in sorted(
                    WAVE8_FOLLOWUP_E_TERMINAL_EXCLUSIONS.items()
                )
            ],
            "wave8_followup_e_location_quarantine_reasons": [
                {"candidate_id": candidate_id, **contract}
                for candidate_id, contract in sorted(
                    WAVE8_FOLLOWUP_E_LOCATION_QUARANTINE_REASONS.items()
                )
            ],
            "wave8_followup_e_point_quarantine_additions": sorted(
                WAVE8_FOLLOWUP_E_POINT_QUARANTINE_ADDITIONS
            ),
            "wave8_followup_e_country_quarantine_additions": sorted(
                WAVE8_FOLLOWUP_E_COUNTRY_QUARANTINE_ADDITIONS
            ),
            "wave8_followup_e_entities_added": len(WAVE8_FOLLOWUP_E_ENTITIES),
            "wave8_followup_e_sources_added": len(WAVE8_FOLLOWUP_E_SOURCES),
            ...
            "wave8_exact_priority_candidate_ids": sorted(
                WAVE8_EXACT_PRIORITY_CONTRACT_IDS
            ),
            "wave8_exact_priority_holds": [
                {"candidate_id": candidate_id, **contract}
                for candidate_id, contract in sorted(
                    WAVE8_EXACT_PRIORITY_HOLDS.items()
                )
            ],
            "wave8_exact_priority_location_quarantine_reasons": [
                {"candidate_id": candidate_id, **contract}
                for candidate_id, contract in sorted(
                    WAVE8_EXACT_PRIORITY_LOCATION_QUARANTINE_REASONS.items()
                )
            ],
            "wave8_exact_priority_point_quarantine_additions": sorted(
                WAVE8_EXACT_PRIORITY_POINT_QUARANTINE_ADDITIONS
            ),
            "wave8_exact_priority_country_quarantine_additions": sorted(
                WAVE8_EXACT_PRIORITY_COUNTRY_QUARANTINE_ADDITIONS
            ),
            "wave8_exact_priority_entities_added": len(
                WAVE8_EXACT_PRIORITY_ENTITIES
            ),
            "wave8_exact_priority_sources_added": len(
                WAVE8_EXACT_PRIORITY_SOURCES
            ),
