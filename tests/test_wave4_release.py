...
class Wave5ReleaseContractTests(unittest.TestCase):
    ...
    def test_exact_release_composition_and_approved_candidate_set(self) -> None:
        ...
        self.assertEqual(len(self.entities), 1_070)
        self.assertEqual(len(self.registry_by_id), 2_409)
        self.assertEqual(
            families,
            {
            (): 40,
            ...
            ("loc_chad_country_study_1990", "washington_post_faya_largeau_1983"): 1,
            ("un_yearbook_1987_chad_libya", "washington_post_aozou_1987"): 1,
            ...
            ("ahilyanagar_district_kharda_fort", "maharashtra_solapur_district_gazetteer"): 1,
            ("bassett_cotton_cote_ivoire_2002", "manuel_general_instruction_primaire_1898", "tauxier_etats_kong_karthala_2003"): 1,
            ("bolanos_geyer_gray_eyed_man_volume_3", "william_walker_war_in_nicaragua"): 1,
            ("costa_rica_mep_santa_rosa", "museo_nacional_costa_rica_campaign"): 1,
            ("handbook_texas_ortiz_parrilla", "oklahoma_history_twin_villages"): 1,
            ("inehrm_gonzalez_lezama_calpulalpan", "mexico_secretariat_defense_calpulalpan"): 1,
            ...
            ("albi_first_carlist_war_north_2022", "aunamendi_arquijas_battles"): 2,
        ...
        self.assertEqual(len(self.results["events"]), 5_487)
