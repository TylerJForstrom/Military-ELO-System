...
class CommittedCoverageArtifactTests(unittest.TestCase):
    ...
    def test_report_matches_release_and_explicit_outcome_family_contract(self) -> None:
        ...
        self.assertEqual(len(rated_events), 5_419)
        ...
        self.assertEqual(families["availability"], "partially_available")
        self.assertEqual(families["events_with_explicit_family_data"], 5_379)
        ...
        self.assertEqual(
            ...
            {"1": 5_017, "2": 236, "3": 95, "4": 26, "5": 4, "6": 1},
        )
        self.assertEqual(families["explicit_mapping_coverage"]["numerator"], 5_379)
        self.assertEqual(families["explicit_mapping_coverage"]["denominator"], 5_419)
        self.assertEqual(families["multiple_family_coverage"]["numerator"], 362)
        self.assertEqual(families["multiple_family_coverage"]["denominator"], 5_379)
    ...
    def test_source_manifest_roles_keep_non_outcome_provenance_out_of_coverage(
        ...
        self.assertEqual(len(self.sources), 1_470)
        ...
        self.assertEqual(
            manifest_digest,
            "1708275b4152b34097946cfdb22b3b0d8ca680680ba1cf7b400b6108d1957457",
        )
        self.assertTrue(
            all(
        ...
        self.assertEqual(
            ...
            ),
            {
                ...
                "identity_boundary_or_context_reference": 1_393,
                "identity_crosswalk": 1,
                "identity_registry": 2,
                "outcome": 873,
                "outcome_consistency_crosscheck": 626,
            },
        )
        self.assertEqual(
            len({source["source_family_id"] for source in self.sources}), 1_203
        )
        outcome_source_ids = {
            source["id"]
            for source in self.sources
        ...
        self.assertEqual(len(outcome_source_ids), 873)
        self.assertEqual(
            len(
                {
        ...
        self.assertEqual(len(selected_outcome_source_ids), 762)
    ...
    def test_dashboard_event_source_contract_matches_release_artifact(self) -> None:
        ...
        self.assertEqual(len(release_by_id), 5_419)
        self.assertEqual(len(dashboard_by_id), 5_419)
