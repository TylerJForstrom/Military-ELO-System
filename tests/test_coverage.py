...
class CommittedCoverageArtifactTests(unittest.TestCase):
    ...
    def test_report_matches_release_and_explicit_outcome_family_contract(self) -> None:
        ...
        self.assertEqual(len(rated_events), 5_416)
        ...
        self.assertEqual(families["availability"], "partially_available")
        self.assertEqual(families["events_with_explicit_family_data"], 5_376)
        ...
        self.assertEqual(
            ...
            {"1": 5_017, "2": 233, "3": 95, "4": 26, "5": 4, "6": 1},
        )
        self.assertEqual(families["explicit_mapping_coverage"]["numerator"], 5_376)
        self.assertEqual(families["explicit_mapping_coverage"]["denominator"], 5_416)
        self.assertEqual(families["multiple_family_coverage"]["numerator"], 359)
        self.assertEqual(families["multiple_family_coverage"]["denominator"], 5_376)
    ...
    def test_source_manifest_roles_keep_non_outcome_provenance_out_of_coverage(
        ...
        self.assertEqual(
            manifest_digest,
            "a625fd7d6c48af867258b4fbcb7828247546568071312f2cb088cae8cd8cdf2c",
        )
        self.assertTrue(
            all(
        ...
        self.assertEqual(
            ...
            ),
            {
                ...
                "identity_boundary_or_context_reference": 1_387,
        ...
        self.assertEqual(
            len({source["source_family_id"] for source in self.sources}), 1_199
        )
        outcome_source_ids = {
            source["id"]
            for source in self.sources
        ...
        self.assertEqual(len(outcome_source_ids), 867)
        self.assertEqual(
            len(
                {
        ...
        self.assertEqual(len(selected_outcome_source_ids), 756)
    ...
    def test_dashboard_event_source_contract_matches_release_artifact(self) -> None:
        ...
        self.assertEqual(len(release_by_id), 5_416)
        self.assertEqual(len(dashboard_by_id), 5_416)
