...
class CommittedCoverageArtifactTests(unittest.TestCase):
    ...
    def test_report_matches_release_and_explicit_outcome_family_contract(self) -> None:
        ...
        self.assertEqual(len(rated_events), 5_466)
        ...
        self.assertEqual(families["availability"], "partially_available")
        self.assertEqual(families["events_with_explicit_family_data"], 5_426)
        ...
        self.assertEqual(
            ...
            {"1": 5_023, "2": 271, "3": 101, "4": 26, "5": 4, "6": 1},
        )
        self.assertEqual(families["explicit_mapping_coverage"]["numerator"], 5_426)
        self.assertEqual(families["explicit_mapping_coverage"]["denominator"], 5_466)
        self.assertEqual(families["multiple_family_coverage"]["numerator"], 403)
        self.assertEqual(families["multiple_family_coverage"]["denominator"], 5_426)
    ...
    def test_source_manifest_roles_keep_non_outcome_provenance_out_of_coverage(
        ...
        self.assertEqual(
            manifest_digest,
            "188699fafd47b6e03ee9d81e378b5c609894a49ffd89635b0f4364c6cc84d6c0",
        )
        self.assertTrue(
            all(
        ...
        self.assertEqual(
            ...
            ),
            {
                ...
                "identity_boundary_or_context_reference": 1_461,
                "identity_crosswalk": 1,
                "identity_registry": 2,
                "outcome": 936,
                "outcome_consistency_crosscheck": 628,
            },
        )
        self.assertEqual(
            len({source["source_family_id"] for source in self.sources}), 1_269
        )
        outcome_source_ids = {
            source["id"]
            for source in self.sources
        ...
        self.assertEqual(len(outcome_source_ids), 936)
        self.assertEqual(
            len(
                {
        ...
        self.assertEqual(len(selected_outcome_source_ids), 818)
    ...
    def test_dashboard_event_source_contract_matches_release_artifact(self) -> None:
        ...
        self.assertEqual(len(release_by_id), 5_466)
        self.assertEqual(len(dashboard_by_id), 5_466)
