...
class CommittedCoverageArtifactTests(unittest.TestCase):
    ...
    def test_report_matches_release_and_explicit_outcome_family_contract(self) -> None:
        ...
        self.assertEqual(len(rated_events), 5_345)
        ...
        self.assertEqual(families["availability"], "partially_available")
        self.assertEqual(families["events_with_explicit_family_data"], 5_305)
        ...
        self.assertEqual(
            ...
            {"1": 4_959, "2": 221, "3": 94, "4": 26, "5": 4, "6": 1},
        )
        self.assertEqual(families["explicit_mapping_coverage"]["numerator"], 5_305)
        self.assertEqual(families["explicit_mapping_coverage"]["denominator"], 5_345)
        self.assertEqual(families["multiple_family_coverage"]["numerator"], 346)
        self.assertEqual(families["multiple_family_coverage"]["denominator"], 5_305)
    ...
    def test_source_manifest_roles_keep_non_outcome_provenance_out_of_coverage(
        ...
        self.assertEqual(len(self.sources), 1_435)
        ...
        self.assertEqual(
            manifest_digest,
            "3a6adbe12854be16ee88039c2efe5c71d10a6e64e1c4fc24aca708008aca1d71",
        )
        self.assertTrue(
            all(
        ...
        self.assertEqual(
            ...
            ),
            {
                ...
                "identity_boundary_or_context_reference": 1_358,
                "identity_crosswalk": 1,
                "identity_registry": 2,
                "outcome": 846,
                "outcome_consistency_crosscheck": 622,
            },
        )
        self.assertEqual(
            len({source["source_family_id"] for source in self.sources}), 1_176
        )
        outcome_source_ids = {
            source["id"]
            for source in self.sources
        ...
        self.assertEqual(len(outcome_source_ids), 846)
        self.assertEqual(
            len(
                {
        ...
        self.assertEqual(len(selected_outcome_source_ids), 734)
    ...
    def test_dashboard_event_source_contract_matches_release_artifact(self) -> None:
        ...
        self.assertEqual(len(release_by_id), 5_345)
        self.assertEqual(len(dashboard_by_id), 5_345)
