...
class CommittedCoverageArtifactTests(unittest.TestCase):
    ...
    def test_report_matches_release_and_explicit_outcome_family_contract(self) -> None:
        ...
        self.assertEqual(len(rated_events), 5_350)
        ...
        self.assertEqual(families["availability"], "partially_available")
        self.assertEqual(families["events_with_explicit_family_data"], 5_310)
        ...
        self.assertEqual(
            ...
            {"1": 4_959, "2": 226, "3": 94, "4": 26, "5": 4, "6": 1},
        )
        self.assertEqual(families["explicit_mapping_coverage"]["numerator"], 5_310)
        self.assertEqual(families["explicit_mapping_coverage"]["denominator"], 5_350)
        self.assertEqual(families["multiple_family_coverage"]["numerator"], 351)
        self.assertEqual(families["multiple_family_coverage"]["denominator"], 5_310)
    ...
    def test_source_manifest_roles_keep_non_outcome_provenance_out_of_coverage(
        ...
        self.assertEqual(len(self.sources), 1_442)
        ...
        self.assertEqual(
            manifest_digest,
            "d45167e948eded6efa2cea25937e3f45fab26f6f6c0fb6e301fdf52daa992d24",
        )
        self.assertTrue(
            all(
        ...
        self.assertEqual(
            ...
            ),
            {
                ...
                "identity_boundary_or_context_reference": 1_365,
                "identity_crosswalk": 1,
                "identity_registry": 2,
                "outcome": 852,
                "outcome_consistency_crosscheck": 623,
            },
        )
        self.assertEqual(
            len({source["source_family_id"] for source in self.sources}), 1_183
        )
        outcome_source_ids = {
            source["id"]
            for source in self.sources
        ...
        self.assertEqual(len(outcome_source_ids), 852)
        self.assertEqual(
            len(
                {
        ...
        self.assertEqual(len(selected_outcome_source_ids), 741)
    ...
    def test_dashboard_event_source_contract_matches_release_artifact(self) -> None:
        ...
        self.assertEqual(len(release_by_id), 5_350)
        self.assertEqual(len(dashboard_by_id), 5_350)
