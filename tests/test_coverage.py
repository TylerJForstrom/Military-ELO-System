...
class CommittedCoverageArtifactTests(unittest.TestCase):
    ...
    def test_report_matches_release_and_explicit_outcome_family_contract(self) -> None:
        ...
        self.assertEqual(len(rated_events), 5_487)
        ...
        self.assertEqual(families["availability"], "partially_available")
        self.assertEqual(families["events_with_explicit_family_data"], 5_447)
        ...
        self.assertEqual(
            ...
            {"1": 5_039, "2": 276, "3": 101, "4": 26, "5": 4, "6": 1},
        )
        self.assertEqual(families["explicit_mapping_coverage"]["numerator"], 5_447)
        self.assertEqual(families["explicit_mapping_coverage"]["denominator"], 5_487)
        self.assertEqual(families["multiple_family_coverage"]["numerator"], 408)
        self.assertEqual(families["multiple_family_coverage"]["denominator"], 5_447)
    ...
    def test_dashboard_event_source_contract_matches_release_artifact(self) -> None:
        ...
        self.assertEqual(len(release_by_id), 5_487)
        self.assertEqual(len(dashboard_by_id), 5_487)
