...
class CommittedCoverageArtifactTests(unittest.TestCase):
    ...
    def test_report_matches_release_and_explicit_outcome_family_contract(self) -> None:
        ...
        self.assertEqual(len(rated_events), 5_546)
        ...
        self.assertEqual(families["availability"], "partially_available")
        self.assertEqual(families["events_with_explicit_family_data"], 5_506)
        ...
        self.assertEqual(
            ...
            {"1": 5_064, "2": 293, "3": 114, "4": 30, "5": 4, "6": 1},
        )
        self.assertEqual(families["explicit_mapping_coverage"]["numerator"], 5_506)
        self.assertEqual(families["explicit_mapping_coverage"]["denominator"], 5_546)
        self.assertEqual(families["multiple_family_coverage"]["numerator"], 442)
        self.assertEqual(families["multiple_family_coverage"]["denominator"], 5_506)
    ...
    def test_source_manifest_roles_keep_non_outcome_provenance_out_of_coverage(
        ...
        self.assertEqual(
            manifest_digest,
            "0fa3ebf4784d0617625486c573dd8327d7be3448a85d1a8a7c909ea371e9ca14",
        )
        self.assertTrue(
            all(
        ...
        self.assertEqual(
            ...
            ),
            {
                ...
                "identity_boundary_or_context_reference": 1_556,
                "identity_crosswalk": 1,
                "identity_registry": 2,
                "outcome": 1_014,
                "outcome_consistency_crosscheck": 703,
            },
        )
        self.assertEqual(
            len({source["source_family_id"] for source in self.sources}), 1_357
        )
        outcome_source_ids = {
            source["id"]
            for source in self.sources
        ...
        self.assertEqual(len(outcome_source_ids), 1_014)
        self.assertEqual(
            len(
                {
        ...
        self.assertEqual(len(selected_outcome_source_ids), 895)
    ...
    def test_dashboard_event_source_contract_matches_release_artifact(self) -> None:
        ...
        self.assertEqual(len(release_by_id), 5_546)
        self.assertEqual(len(dashboard_by_id), 5_546)
