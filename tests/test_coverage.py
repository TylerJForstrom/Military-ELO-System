...
class CommittedCoverageArtifactTests(unittest.TestCase):
    ...
    def test_report_matches_release_and_explicit_outcome_family_contract(self) -> None:
        ...
        self.assertEqual(len(rated_events), 5_471)
        ...
        self.assertEqual(families["availability"], "partially_available")
        self.assertEqual(families["events_with_explicit_family_data"], 5_431)
        ...
        self.assertEqual(
            ...
            {"1": 5_023, "2": 276, "3": 101, "4": 26, "5": 4, "6": 1},
        )
        self.assertEqual(families["explicit_mapping_coverage"]["numerator"], 5_431)
        self.assertEqual(families["explicit_mapping_coverage"]["denominator"], 5_471)
        self.assertEqual(families["multiple_family_coverage"]["numerator"], 408)
        self.assertEqual(families["multiple_family_coverage"]["denominator"], 5_431)
    ...
    def test_source_manifest_roles_keep_non_outcome_provenance_out_of_coverage(
        ...
        self.assertEqual(
            manifest_digest,
            "7b621e6f296f77ce22a65d75d96c43157d1a6d033494bf39b42503570ab397f7",
        )
        self.assertTrue(
            all(
        ...
        self.assertEqual(
            ...
            ),
            {
                ...
                "identity_boundary_or_context_reference": 1_469,
                "identity_crosswalk": 1,
                "identity_registry": 2,
                "outcome": 944,
                "outcome_consistency_crosscheck": 630,
            },
        )
        self.assertEqual(
            len({source["source_family_id"] for source in self.sources}), 1_277
        )
        outcome_source_ids = {
            source["id"]
            for source in self.sources
        ...
        self.assertEqual(len(outcome_source_ids), 944)
        self.assertEqual(
            len(
                {
        ...
        self.assertEqual(len(selected_outcome_source_ids), 826)
    ...
    def test_dashboard_event_source_contract_matches_release_artifact(self) -> None:
        ...
        self.assertEqual(len(release_by_id), 5_471)
        self.assertEqual(len(dashboard_by_id), 5_471)
