...
class CommittedCoverageArtifactTests(unittest.TestCase):
    ...
    def test_report_matches_release_and_explicit_outcome_family_contract(self) -> None:
        ...
        self.assertEqual(len(rated_events), 5_414)
        ...
        self.assertEqual(families["availability"], "partially_available")
        self.assertEqual(families["events_with_explicit_family_data"], 5_374)
        ...
        self.assertEqual(
            ...
            {"1": 5_017, "2": 231, "3": 95, "4": 26, "5": 4, "6": 1},
        )
        self.assertEqual(families["explicit_mapping_coverage"]["numerator"], 5_374)
        self.assertEqual(families["explicit_mapping_coverage"]["denominator"], 5_414)
        self.assertEqual(families["multiple_family_coverage"]["numerator"], 357)
        self.assertEqual(families["multiple_family_coverage"]["denominator"], 5_374)
    ...
    def test_source_manifest_roles_keep_non_outcome_provenance_out_of_coverage(
        ...
        self.assertEqual(
            manifest_digest,
            "ee753aff657e8a204ab6c01a2096a2bd2f3b56bc272e82dd9d0b6a71e457bf6f",
        )
        self.assertTrue(
            all(
        ...
        self.assertEqual(
            ...
            ),
            {
                ...
                "identity_boundary_or_context_reference": 1_380,
        ...
        self.assertEqual(
            len({source["source_family_id"] for source in self.sources}), 1_193
        )
        outcome_source_ids = {
            source["id"]
            for source in self.sources
        ...
        self.assertEqual(len(outcome_source_ids), 863)
        self.assertEqual(
            len(
                {
        ...
        self.assertEqual(len(selected_outcome_source_ids), 752)
    ...
    def test_dashboard_event_source_contract_matches_release_artifact(self) -> None:
        ...
        self.assertEqual(len(release_by_id), 5_414)
        self.assertEqual(len(dashboard_by_id), 5_414)
