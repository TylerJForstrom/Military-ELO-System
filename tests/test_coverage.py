...
class CommittedCoverageArtifactTests(unittest.TestCase):
    ...
    def test_report_matches_release_and_explicit_outcome_family_contract(self) -> None:
        ...
        self.assertEqual(len(rated_events), 5_456)
        ...
        self.assertEqual(families["availability"], "partially_available")
        self.assertEqual(families["events_with_explicit_family_data"], 5_416)
        ...
        self.assertEqual(
            ...
            {"1": 5_023, "2": 264, "3": 98, "4": 26, "5": 4, "6": 1},
        )
        self.assertEqual(families["explicit_mapping_coverage"]["numerator"], 5_416)
        self.assertEqual(families["explicit_mapping_coverage"]["denominator"], 5_456)
        self.assertEqual(families["multiple_family_coverage"]["numerator"], 393)
        self.assertEqual(families["multiple_family_coverage"]["denominator"], 5_416)
    ...
    def test_source_manifest_roles_keep_non_outcome_provenance_out_of_coverage(
        ...
        self.assertEqual(
            manifest_digest,
            "d954019021c0035fe27efbc9736877419b1bc679f1a953bbd2496954ac7d3cc2",
        )
        self.assertTrue(
            all(
        ...
        self.assertEqual(
            ...
            ),
            {
                ...
                "identity_boundary_or_context_reference": 1_451,
        ...
        self.assertEqual(
            len({source["source_family_id"] for source in self.sources}), 1_259
        )
        outcome_source_ids = {
            source["id"]
            for source in self.sources
        ...
        self.assertEqual(len(outcome_source_ids), 928)
        self.assertEqual(
            len(
                {
        ...
        self.assertEqual(len(selected_outcome_source_ids), 810)
    ...
    def test_dashboard_event_source_contract_matches_release_artifact(self) -> None:
        ...
        self.assertEqual(len(release_by_id), 5_456)
        self.assertEqual(len(dashboard_by_id), 5_456)
