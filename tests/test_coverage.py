...
class CommittedCoverageArtifactTests(unittest.TestCase):
    ...
    def test_report_matches_release_and_explicit_outcome_family_contract(self) -> None:
        ...
        self.assertEqual(len(rated_events), 5_444)
        ...
        self.assertEqual(families["availability"], "partially_available")
        self.assertEqual(families["events_with_explicit_family_data"], 5_404)
        ...
        self.assertEqual(
            ...
            {"1": 5_020, "2": 255, "3": 98, "4": 26, "5": 4, "6": 1},
        )
        self.assertEqual(families["explicit_mapping_coverage"]["numerator"], 5_404)
        self.assertEqual(families["explicit_mapping_coverage"]["denominator"], 5_444)
        self.assertEqual(families["multiple_family_coverage"]["numerator"], 384)
        self.assertEqual(families["multiple_family_coverage"]["denominator"], 5_404)
    ...
    def test_source_manifest_roles_keep_non_outcome_provenance_out_of_coverage(
        ...
        self.assertEqual(
            manifest_digest,
            "b88ff33a8f5cfb241daa42805348e066cb320718f6d46583322d3a3f3e67b210",
        )
        self.assertTrue(
            all(
        ...
        self.assertEqual(
            ...
            ),
            {
                ...
                "identity_boundary_or_context_reference": 1_446,
        ...
        self.assertEqual(
            len({source["source_family_id"] for source in self.sources}), 1_255
        )
        outcome_source_ids = {
            source["id"]
            for source in self.sources
        ...
        self.assertEqual(len(outcome_source_ids), 923)
        self.assertEqual(
            len(
                {
        ...
        self.assertEqual(len(selected_outcome_source_ids), 805)
    ...
    def test_dashboard_event_source_contract_matches_release_artifact(self) -> None:
        ...
        self.assertEqual(len(release_by_id), 5_444)
        self.assertEqual(len(dashboard_by_id), 5_444)
