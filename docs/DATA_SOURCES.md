...
The 1,421-source registry contains 836 sources carrying the direct outcome role
across 765 dependency families. Current event-level contracts select 726 of
those sources across 669 families. This maps 5,301 of 5,341 rated events:
5,077 HCED encounters, 64 IWD parent wars, 153 IWBD battles, and 7 UCDP
termination episodes. Of the mapped events, 4,959 cite one declared direct
outcome family and 342 cite between two and six. Family cardinality is an audit
...
For the 5,077 rated HCED events, the release-to-candidate join is an
exact bijection: 1,887 crosswalk-resolved events, 2,423 label-resolved events,
and 767 candidate-keyed reviewed events: 76 from Wave 6, 192 from Wave 7, and
499 from Wave 8, with no missing, ambiguous, or colliding bindings.
Candidate-ID-only policy manifests withhold 343 Point fields and 94
country/jurisdiction fields, with 46 overlapping and 391 unique
...
source-transcribed Point, 4,982 carry the source's modern
country/geographic-jurisdiction string, and 5,031 carry at least one location
...
- 2,348 time-bounded polity identities in the rated-and-unrated registry;
- 998 release entity records, of which 991 distinct IDs actually participate
  in rated events;
- 1,421 registered provenance sources across 1,165 source families; and
- 5,341 rating events: 40 manually curated events, 1,887 crosswalk-resolved,
  2,423 label-resolved, and 767 candidate-keyed HCED tactical encounters
  (76 Wave 6 + 192 Wave 7 + 499 Wave 8),
...
candidate IDs already published in the ledger before ranking and reports 2,290
touched deferred rows, 2,222 unresolved normalized labels, and 1,066
...
superseded source envelope. None receives a rating or counts among the 991
participant IDs.
...
review now produces the current measured 2,348-row registry; every release
...
candidates, 18,053 remain outside the rating ledger because their layer,
...
Exactly 5,301 rated events have an explicit direct-outcome mapping; the
...
family and 342 cite more than one.
