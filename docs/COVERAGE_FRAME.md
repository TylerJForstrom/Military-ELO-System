...
The current status-aware HCED numerators are 4,836 unreviewed source Points,
5,144 source-transcribed geographic-jurisdiction labels, and 5,193 events with
closed location-provenance objects, all over 5,239 HCED-derived rated events.
Verified-location coverage is `not_available`. The report separately publishes
the frozen policy counts rather than inferring policy from absence: 403 Point
fields withheld by quarantine, 94 country/jurisdiction fields withheld, 46
events in both quarantine manifests, and 451 unique quarantine-manifest events.
...
and map 5,466 of 5,506 rated events. The mapped population contains 5,239
HCED-derived events, 66 IWD parent wars, 153 IWBD battles, and 8 UCDP
termination episodes. Of those mapped events, 5,058 cite one declared direct-
