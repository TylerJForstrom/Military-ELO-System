...
The current release catalogues 1,701 polity identities and contains 345 release entity records, of which 343 actually participate across 4,842 rated events. It reports all 27,014 staged source records separately. The staged total includes identity records and promoted evidence; of 23,390 event-like candidates, 18,552 remain outside the rating ledger. These are different denominators and must never be collapsed into a claim that every catalogued or released polity has been rated.
