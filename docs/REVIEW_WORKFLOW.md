...
The current release catalogues 1,590 polity identities, rates 226 entities across 4,341 events, and reports all 27,083 staged source records separately. The staged total includes identity records and promoted evidence; of 23,459 event-like candidates, 19,125 remain outside the rating ledger. These are different denominators and must never be collapsed into a claim that every catalogued polity has been rated.
