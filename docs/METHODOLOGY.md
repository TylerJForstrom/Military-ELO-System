...
The polity registry and rating ledger are separate products. The current expanded provisional release catalogues 1,582 time-bounded polity identities, but only 177 have accepted rating evidence. Its 2,620 events consist of 40 manually curated events, 1,377 crosswalk-resolved HCED tactical encounters, 1,012 label-resolved HCED tactical encounters, 44 coalition-aggregated IWD strategic parent wars, 142 IWBD tactical battles, and 5 UCDP conflict-termination strategic episodes. The review queues hold 27,083 staged source records, of which 23,459 are event-like candidates; 20,851 of those remain outside the rating ledger. An unrated registry entry has no Elo result; it is not assigned a baseline score, loss, or implied lack of military success.
